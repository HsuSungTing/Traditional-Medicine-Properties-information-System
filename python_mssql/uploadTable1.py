...
duplicate_ids = excel_sheet[excel_sheet.duplicated('Med_id')]['Med_id'].tolist()
duplicate_ids += excel_sheet[excel_sheet['Med_id'].isin(existing_ids_df)]['Med_id'].tolist()
...
if invalid_ids or duplicate_ids:
    ...
    excel_sheet = excel_sheet[~excel_sheet['Med_id'].isin(invalid_ids + duplicate_ids)]
